## Jekyll
1、一般安装步骤：ruby->gem->jekyll

2、关于安装Jekyll，按照此向导走：[Setting up your Pages site locally with Jekyll][1]

3、关于升级Mac上Ruby,可以使用rvm，安装步骤在此：[Upgrade ruby in mac][2]
...
[2]:http://www.cnblogs.com/daguo/p/4097263.html
